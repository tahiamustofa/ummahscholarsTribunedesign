...
const EventFuntionState = () => {
    ...
    return (
        <>
            <h2 className='text-3xl font-bold'>Event Funtion and State</h2>

            {/* <button onClick={() => alert('hello!!!')} className="btn bg-[#FEE502] text-[#181600] border-[#f1d800]">
            ...
            <button onClick={() => sayHELLO('tahia')} className="btn bg-[#FEE502] text-[#181600] border-[#f1d800]">
                new btn
            </button>
            <h2 className='text-4xl font-bold'> my name is {fname}</h2>

            <button onClick={() => setFname('Farzeen')} className="btn bg-red-400 text-[#181600] border-[#f1d800]">
                set name
            </button>
        </>
    )
...
export default EventFuntionState